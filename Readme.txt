...
Unix-based operating system. An executable file is provided as well
as the source code and Linux Makefiles to aid users in compilation on
...
The following commands can be used to extract GSFLOW:
    ...
    gunzip GSFLOWv1_1_4.tar.gz
    tar -xvf GSFLOWv1_1_4.tar
...
containing the executables for the prior release should be removed.

As an alternative, the executable file, gsflow.exe, in the
GSFLOW_1.1.4/bin directory can be copied into a directory already
...
The executable file provided in gsflow_1.1.4/bin was compiled on a
