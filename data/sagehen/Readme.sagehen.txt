...
Several GSFLOW Control and shell scripts are provided to run the sample 
...
control and shell script files are provided in the 'linux' subdirectory. 
...
Type the name of the shell script files in a Linux Terminal to run the model.
(see the Readme.txt file in the main GSFLOW directory).
