...
!   Local Variables
      ...
      INTEGER, SAVE :: Iorder, Igworder, Ndown, Gwcasc_flg, Nsegmentp1
...
!***********************************************************************
      ...
      Version_cascade = '$Id: cascade.f90 7588 2015-08-18 22:58:42Z rsregan $'
...
!***********************************************************************
      ...
      USE PRMS_CASCADE
      USE PRMS_MODULE, ONLY: Nhru, Ngw, Nsegment, Print_debug, Ncascade, Ncascdgw
