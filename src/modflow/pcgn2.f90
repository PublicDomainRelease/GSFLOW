MODULE PCGN
  ...
  REAL, DIMENSION(:), POINTER :: CR, CC, CV
  DOUBLE PRECISION, DIMENSION(:), POINTER ::  HCOF, RHS
...
810 FORMAT (1X,/,1X,20X,'***WARNING!!!***',/, &
  ...
  SUBROUTINE PCGN2AP(HNEWAP,RHSAP,CRAP,CCAP,CVAP,HCOFAP,IBDAP, &  
    ...
    REAL, DIMENSION(*), TARGET, INTENT(IN) :: CRAP, CCAP, CVAP
    DOUBLE PRECISION, DIMENSION(*), TARGET, INTENT(INOUT)  :: RHSAP, HCOFAP
