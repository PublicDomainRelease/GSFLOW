...
C  this file to use the IMPLICIT NONE statement.
      ...
      SUBROUTINE GWF2BAS7AR(INUNIT,CUNIT,VERSION,VERSION2,IUDIS,IUZON,
     2              IUMLT,MAXUNIT,IGRID,IUOC,HEADNG,IUPVAL,MFVNAM)
C     ******************************************************************
...
C2------Open all files in name file.
     ...
     &                 VERSION,VERSION2,INBAS,MAXUNIT,MFVNAM)
C
...
C
    ...
    9    FORMAT(1X,/9X,'NO FLOW EQUATION TO SOLVE IN TIME STEP',I6,
...
C6------IF SO THEN CALL A ULASAV OR ULASV2 TO RECORD DRAWDOWN.
   ...
   74   FORMAT(1X,/1X,'DRAWDOWN WILL BE SAVED ON UNIT ',I4,
     1      ' AT END OF TIME STEP',I6,', STRESS PERIOD ',I4)
        IFIRST=0
        IF(CDDNFM.EQ.' ') THEN
...
C     ------------------------------------------------------------------
  ...
  199 FORMAT(1X,///9X,'TIME SUMMARY AT END OF TIME STEP',I6,
...
C
  260 FORMAT('1',/2X,'VOLUMETRIC BUDGET FOR ENTIRE MODEL AT END OF'
     1,' TIME STEP',I6,', STRESS PERIOD',I4/2X,81('-'))
...
C1------TIME STEP.
    ...
    5    FORMAT(1X,/1X,'OUTPUT CONTROL WAS SPECIFIED FOR A NONEXISTENT',
     ...
     3   /1X,'OUTPUT CONTROL STRESS PERIOD ',I4,'   TIME STEP',I6,/
     4   1X,'MODEL STRESS PERIOD ',I4,'   TIME STEP',I6,/
...
C5------RETURN.
     ...
     1              NIUNIT,VERSION,VERSION2,INBAS,MAXUNIT,MFVNAM)
C     ******************************************************************
C     OPEN FILES.
C     ******************************************************************
C
...
C     ------------------------------------------------------------------
      ...
      CHARACTER*(*) VERSION,VERSION2,MFVNAM
      CHARACTER*40 SPACES
...
C6------SPECIAL CHECK FOR 1ST FILE.
     ...
     1          FORM='FORMATTED',ACCESS='SEQUENTIAL')
          WRITE(IOUT,60) MFVNAM(:4),SPACES(1:INDENT),VERSION2(:16)
