...
C
    ...
    9    FORMAT(1X,/11X,'NO FLOW EQUATION TO SOLVE IN TIME STEP',I6,
...
C     ------------------------------------------------------------------
  ...
  199 FORMAT(1X,///10X,'TIME SUMMARY AT END OF TIME STEP',I6,
...
C
  260 FORMAT('1',/2X,'VOLUMETRIC BUDGET FOR ENTIRE MODEL AT END OF'
     1,' TIME STEP',I6,' IN STRESS PERIOD',I4/2X,81('-'))
